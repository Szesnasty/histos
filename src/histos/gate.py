...
from histos import coverage as _coverage
from histos import wrappers as _wrappers
...
from histos.engine import Engine, EscalationTier, ResourceResolver
...
class Gate:
    ...
    def ungated_tools(self, tools: Iterable[Any]) -> list[str]:
        """Which of ``tools`` this Gate does not mediate. See :mod:`histos.coverage`."""
        return _coverage.ungated_tools(self, tools)

    def coverage(self, tools: Iterable[Any]) -> dict[str, list[str]]:
        """The full mediation report for ``tools``. See :mod:`histos.coverage`."""
    ...
    def _wrap_sync(self, tool: Callable[..., Any], tool_name: str, bound: Principal | None) -> Callable[..., Any]:
        """The synchronous call path. See :mod:`histos.wrappers`."""
    ...
    def _wrap_async(self, tool: Callable[..., Any], tool_name: str, bound: Principal | None) -> Callable[..., Any]:
        """The asynchronous call path. See :mod:`histos.wrappers`."""
