...
# Re-exported with `as`, which is the explicit-re-export spelling: `histos.policy.contracts.
...
from histos.policy.authz import Binding as Binding
from histos.policy.authz import Constraint as Constraint
from histos.policy.authz import ConstraintResult as ConstraintResult
...
class ToolContract:
    ...
    def shape_fingerprint(self) -> dict[str, Any]:
        ...
        adds an ownership rule. See ``histos.provenance.lockfile``.
        """
